cat("Running: ./application/anglavy_tables.R", "\n\n")
...
data <- read_dta(APPLICATION_DATA_FILE_PATH)
...
df_results <- data.frame(
  ...
  bw_cov = numeric(total_combinations),
  bw_mse = numeric(total_combinations),
...
for (test in TESTS) {
  ...
  for (cutoff in CUTOFFS) {
    ...
    for (bandwidth in BANDWIDTHS) {
      ...
      ## =======================================================================
      ## LAMBDA CLASS ESTIMATOR WITH N; = N(1)
      ## =======================================================================
      ...
      ## =======================================================================
      ## LAMBDA CLASS ESTIMATOR WITH N; = N(4)
      ## =======================================================================
...
write.csv(df_results, APPLICATION_CSV_FILE_PATH, row.names = FALSE) 
if (PRINT_OUTPUT) {
  print(paste0("Output saved to: '", APPLICATION_CSV_FILE_PATH, "'."))
}
